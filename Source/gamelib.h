...
#define KEY_LEFT  (char)0x25 // keyboard左箭頭
#define KEY_UP  (char)0x26 // keyboard上箭頭
#define KEY_RIGHT  (char)0x27 // keyboard右箭頭
#define KEY_DOWN  (char)0x28 // keyboard下箭頭
#define KEY_SPACE  (char)0x20
#define KEY_CTRL  (char)0x11
#define KEY_TAB  9
#define KEY_ESC  27
#define U 0
#define D 1
