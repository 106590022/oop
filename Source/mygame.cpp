...
void CGameStateInit::OnInit()
{
   ...
   // logo.LoadBitmap(IDB_BACKGROUND);
    ...
    //
	c_menu.LoadBitmap();
	CAudio::Instance()->Load(AUDIO_BOOM, "sounds\\boom.mp3");	// 載入編號0的聲音ding.wav
	CAudio::Instance()->Load(AUDIO_SHOT, "sounds\\Laser_Gun.mp3");
	CAudio::Instance()->Load(AUDIO_FOREST, "sounds\\magic_forest.mp3");	// 載入編號2的聲音ntut.mid
...
void CMenu::LoadBitmap()
{
	...
	// 或 pic.LoadBitmap(“Bitmaps\\Tortoise.bmp”);
}
void CMenu::OnShow()
{
	pic.SetTopLeft(x, y);
